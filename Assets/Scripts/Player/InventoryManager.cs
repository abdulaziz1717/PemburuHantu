        ...
        foreach(var upgradeOption in upgradeUIOptions)
        {
            ...
            if(upgradeType == 1)
            {
                ...
                if(chosenWeaponUpgrade != null)
                {
                    ...
                    if (newWeapon) //spawn a new weapon
                    {
                        ...
                        upgradeOption.upgradeDescriptionDisplay.text = chosenWeaponUpgrade.weaponData.Description; upgradeOption.upgradeNameDisplay.text = chosenWeaponUpgrade.weaponData.Name;
                    }
            ...
            else if(upgradeType == 2)
            {
                ...
                if(chosenPassiveItemUpgrade != null)
                {
                    ...
                    if (newPassiveItem)
                    {
                        upgradeOption.upgradeButton.onClick.AddListener(() => player.SpawnPassiveItem(chosenPassiveItemUpgrade.initialPassiveItem)); //apply button funtionality
                        //apply initial description and name
                        upgradeOption.upgradeDescriptionDisplay.text = chosenPassiveItemUpgrade.passiveItemData.Description; upgradeOption.upgradeNameDisplay.text = chosenPassiveItemUpgrade.passiveItemData.Name;
                    }
